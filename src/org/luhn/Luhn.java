...
public class Luhn {
	 ...
	 * @return
	 */
	public static boolean validate(String numberString) throws NumberFormatException {
	 ...
	 * @return
	 */
	public static int checkSum(String numberString) throws NumberFormatException {
	 ...
	 * @return
	 */
	public static int checkSum(String numberString, boolean noCheckDigit) throws NumberFormatException {		
